...
if ( empty( $admin ) ) :
	...
	if ( isset( $_POST['button_filter'] ) ) :
		...
		$sql = $brw->display_borrowing_filter_based_date( $start_date, $last_date );
	else :
		$sql = $brw->display_borrowing();
	...
	<body>
		<div class="container">
			<div class="row">
			  	<div class="col-md-12 report-borrowing">
					<div class="table-responsive">
						<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" id="form_filter">
							...
							<div class="col-md-12 title-info"><p>LAPORAN PEMINJAMAN BUKU</p>
							...
							<table class="table table-striped table-hover" id="my-dataTables">
								<thead>
			                        <tr class="headings">
			                            ...
			                            <th style="text-align:right;">Status Peminjaman</th>
			                        </tr>
			                    </thead>
			                            ...
			                            <tr>
			                                ...
			                                <td align="right">
			                                    ...
			                                    if ( empty( $returning_by_id_borrowing->rowCount() ) ) {
			                                        echo '<span style="font-weight: bold; color: #d9534f;">Terpinjam</span>'; 
			                                    } else {
			                                        echo '<span style="font-weight: bold; color: #7AD87A;">Kembali</span>'; 
			                                    }
			                                    ?>
			                                </td>
										</tr>
